...
- ✔️ Компоновщик :
	...
	- [Вычислитель списков МО алгоритмов >> Линейные регрессии + Ансамбли линейных регрессий](https://github.com/andybeardness/Learning-OOP/tree/main/12-Composite-ListsEnseblesML) | скоро
...
- 🔸 Состояние :
	...
	- [Анализ марковских процессов состояний в поликлинике](#) | скоро
...
- 🔸 Заместитель :
	...
	- [Проверка курса доллара с GUI](#) | скоро
