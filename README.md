...
_Несмотря на лёгкий кринж от обложки, книга настолько крутая, что хочется её советовать каждому_
...
**Контекст** : Ситуация, в которой применяется паттерн. Ситуация должна быть достаточно типичной и распространённой

**Задача** : Цель, который ходите добиться в контексте. Учитывая совокупность ограничений контекста

**Решение** : Обобщённая архитектура, которая достигает заданной цели при соблюдении ограничений
...
10. **Существуют Антипаттерны**
	> Они описывают очевидное, но плохое решение задачи
...
Пригодился собственный опыт, когда приходилось реализовывать приложения используя паттерн

Это наводило на мысли об использовании паттерна и той реализации, где он будет полезен