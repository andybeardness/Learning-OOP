...
- ✔️ Декоратор
	...
	- [Калькулятор калорий с GUI Hard Core](https://github.com/andybeardness/Learning-OOP/tree/main/03-Decorator-CaloriesCalculatorHardCore) | (скоро)

- 🔸 Простая фабрика и Фабричный метод :
...
- 🔸 Абстрактная фабрика :
	...
	- [Адаптиное GUI >> Время + Язык + Страна](#) | (скоро) ????
